...
export function UserEditModal({ closeHandler, user }) {
    ...
    function changeHandler(e) {
        ...
        const validationResult = fieldName === 'rePassword' ? comparePasswords(formData.password.value, formData.rePassword.value) : profileEditValidations(fieldName.trim(), fieldValue.trim());
                ...
                <div className={styles["user-container"]}>
                    ...
                    <form>
                        ...
                        <div className={styles["form-actions"]}>
                            <button className={styles["action-save"]} onClick={submitHandler}>Save</button>
